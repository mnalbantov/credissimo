    ...
    <div class="wrapper wrapper-content animated fadeInRight ecommerce">
        ...
        <form class="form" method="POST" action="{{ route ('products.store') }} " enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                    ...
                                    <input id="price" class="form-control" value="{{ old ('name') }}" name="name" required  type="text" placeholder="iPhone 6S">
                                </div>
                                @if ($errors->has('name'))
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                    ...
                                    <textarea name="description" class="form-control"  placeholder="Awesome model phone :)" required id="description" rows="10" cols="50">{{ old('description') }}</textarea>
                                </div>
                        ...
                        <div class="row">
                                    ...
                                    <select required class="form-control" name="category" id="category">
                                        @if($categories)
                                            @foreach($categories as $category)
                                                <option {{ old('category') == $category->id ? "selected":"" }} value="{{$category->id}}">{{$category->CategoryName or ''}}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group{{ $errors->has('sku') ? ' has-error' : '' }}">
                                    ...
                                    <input id="sku" class="form-control" value="{{ old('sku')}} " name="sku"   type="text" placeholder="APPL-123">
                                </div>
                                @if ($errors->has('sku'))
                                    <span class="help-block">
                        ...
                        <div class="row">
                                    ...
                                    <select required class="form-control" name="manufacturer" id="manufacturer">
                                        @if($manufacturers)
                                            @foreach($manufacturers as $manufacturer)
                                                <option {{ old('manufacturer') == $manufacturer->id ? "selected":"" }} value="{{$manufacturer->id}}">{{$manufacturer->name or ''}}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group{{ $errors->has('lot') ? ' has-error' : '' }}">
                                    ...
                                    <input id="lot" class="form-control" value="{{ old('lot') }} " name="lot"   type="text" placeholder="LOT123S23">
                                </div>
                                @if ($errors->has('lot'))
                                    <span class="help-block">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">
                                    ...
                                    <input  id="price"  class="form-control" name="price"  value="{{ old('price') }}" required  type="number" step="0.01" placeholder="124.99">
                                </div>
                                @if ($errors->has('price'))
                                    <span class="help-block">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group{{ $errors->has('quantity') ? ' has-error' : '' }}">
                                    ...
                                    <input id="quantity" class="form-control" name="quantity" value="{{ old('quantity') }}" required  type="number" step="any" placeholder="80">
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group{{ $errors->has('display') ? ' has-error' : '' }}">
                                    ...
                                    <input id="display" class="form-control" value="{{ old('display') }}" name="display"   type="text" placeholder="5 inches">
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group{{ $errors->has('camera') ? ' has-error' : '' }}">
                                    ...
                                    <input id="camera" class="form-control" value="{{ old('camera') }}" name="camera"   type="text" placeholder="12 MP Carlezeiss">
                                </div>
                                @if ($errors->has('display'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('display') }}</strong>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group{{ $errors->has('os') ? ' has-error' : '' }}">
                                    ...
                                    <input id="os" class="form-control" value="{{ old('os') }}" name="os"   type="text" placeholder="iOS 10.2 / Android 5.6">
                                </div>
                                @if ($errors->has('os'))
                                    <span class="help-block">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="form-group">
                        <input class="form-control btn btn-primary" type="submit" value="Add Product" name="submit">
                    </div>
                </div>
            </div>
